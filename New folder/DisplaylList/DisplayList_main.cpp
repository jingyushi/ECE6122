...
float colorBlack[3] = { 0.01, 0.01, 0.01 };
float colorOrange[3] = { 1.0, 0.5, 0.5 };
float colorGreen[3] = { 0.0, 1.0, 0.0 };
float colorDarkGreen[3] = { 0.0, 0.5, 0.0 };
...
//    glMaterialfv(GL_FRONT, GL_AMBIENT, colorWhite);
...
void init()
{
    ...
    // Create Snowmen displaylist
    theSnowmen = glGenLists(1);
    glNewList(theSnowmen, GL_COMPILE);
